...
{
    QString fileName = QFileDialog::getSaveFileName(this, tr("Specify MAVLink log file name"), QStandardPaths::standardLocations(QStandardPaths::DesktopLocation).first(), tr("MAVLink Logfile (*.mavlink);;"));
