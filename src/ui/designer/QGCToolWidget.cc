...
void QGCToolWidget::exportWidget()
{
    ...
    QString fileName = QFileDialog::getSaveFileName(this, tr("Specify File Name"), QStandardPaths::standardLocations(QStandardPaths::DesktopLocation).first(), tr("QGroundControl Widget (*%1);;").arg(widgetFileExtension));
...
{
    const QString widgetFileExtension(".qgw");
    QString fileName = QFileDialog::getOpenFileName(this, tr("Specify File Name"), QStandardPaths::standardLocations(QStandardPaths::DesktopLocation).first(), tr("QGroundControl Widget (*%1);;").arg(widgetFileExtension));
