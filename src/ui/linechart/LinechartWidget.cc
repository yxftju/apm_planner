...
void LinechartWidget::startLogging()
{
    ...
    QString fileName = QFileDialog::getSaveFileName(this, tr("Specify log file name"), QStandardPaths::standardLocations(QStandardPaths::DesktopLocation).first(), tr("Logfile (*.log);;"));
    ...
    while (!(fileName.endsWith(".log")) && !abort && fileName != "") {
        ...
        fileName = QFileDialog::getSaveFileName(this, tr("Specify log file name"), QStandardPaths::standardLocations(QStandardPaths::DesktopLocation).first(), tr("Logfile (*.log);;"));
    }
