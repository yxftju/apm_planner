...
void MAVLinkProtocol::loadSettings()
{
    ...
    {
        m_logfile = new QFile(QStandardPaths::standardLocations(QStandardPaths::HomeLocation) + "/qgroundcontrol_packetlog.mavlink");
    }
    // Enable logging
...
QString MAVLinkProtocol::getLogfileName()
{
    ...
    {
        return QStandardPaths::standardLocations(QStandardPaths::HomeLocation) + "/qgroundcontrol_packetlog.mavlink";
    }
}
